...
cp -a main.py pdf_orcamento_match_os.py 2>/dev/null backups_rapidos/ || true

echo "[2/2] Gerando pdf_orcamento_match_os.py com header/rodapé idênticos à OS…"
...
echo "OK. Reinicie o serviço em seguida."
